...
export function generateDefs(uid) {
  ...
  defs +=
    ...
    `</linearGradient>`;
  defs +=
    `<linearGradient id="cabHi${uid}" x1="0" y1="0" x2="0" y2="1">` +
  ...
  // Bulb gradients
  defs +=
    `<radialGradient id="bulbOn${uid}" cx="35%" cy="30%" r="70%">` +
    `<stop offset="0%" stop-color="#fffbe6"/>` +
    `<stop offset="40%" stop-color="#ffd84a"/>` +
    `<stop offset="100%" stop-color="#a85a00"/>` +
    `</radialGradient>`;
  defs +=
    `<radialGradient id="bulbRed${uid}" cx="35%" cy="30%" r="70%">` +
  ...
  // Special gradients
  defs +=
    `<linearGradient id="goldBar${uid}" x1="0" y1="0" x2="0" y2="1">` +
    `<stop offset="0%" stop-color="#ffe066"/>` +
    `<stop offset="55%" stop-color="#f5a623"/>` +
    `<stop offset="100%" stop-color="#a86610"/>` +
    `</linearGradient>`;
  defs +=
    `<linearGradient id="banner${uid}" x1="0" y1="0" x2="0" y2="1">` +
    ...
    `</linearGradient>`;
  defs +=
    `<linearGradient id="red7${uid}" x1="0" y1="0" x2="0" y2="1">` +
    `<stop offset="0%" stop-color="#ff5a5a"/>` +
    `<stop offset="50%" stop-color="#e11d1d"/>` +
    `<stop offset="100%" stop-color="#7a0707"/>` +
    `</linearGradient>`;
  defs +=
    `<linearGradient id="darkPanel${uid}" x1="0" y1="0" x2="0" y2="1">` +
    `<stop offset="0%" stop-color="#0a0612"/>` +
    `<stop offset="100%" stop-color="#1a0d2a"/>` +
    `</linearGradient>`;
  defs +=
    `<radialGradient id="scrGlow${uid}" cx="50%" cy="50%" r="60%">` +
